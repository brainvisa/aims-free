...
#ifndef		matrix_ecat7_h
#define		matrix_ecat7_h
/*  19-sep-2002: 
...
/*	Unsigned Short Big and Little Endian, PseudoColor, TrueColor,	BitData*/
...
enum ProcessingCode { NotProc=0, Norm=1, Atten_Meas=2, Atten_Calc=4,
	...
	ArcPrc=256, DecayPrc=512, OnComPrc=1024,  RandomSub=2048 };
