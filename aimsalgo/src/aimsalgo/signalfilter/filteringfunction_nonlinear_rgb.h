...
namespace aims {
  ...
  AIMS_NONLIN_FILTERFUNC_MULTICHANNEL_DECLARE(NotNullMajorityFilterFunc, AimsRGB);
  AIMS_NONLIN_FILTERFUNC_MULTICHANNEL_DECLARE(NotNullMajorityFilterFunc, AimsRGBA);
