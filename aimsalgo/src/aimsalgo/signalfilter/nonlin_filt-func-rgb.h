...
AIMSALGO_NONLINFILT_FUNC_MULTICHANNEL_DECLARE(NotNullMedianFilterFunc, AimsRGB)
AIMSALGO_NONLINFILT_FUNC_MULTICHANNEL_DECLARE(NotNullMedianFilterFunc, AimsRGBA)
