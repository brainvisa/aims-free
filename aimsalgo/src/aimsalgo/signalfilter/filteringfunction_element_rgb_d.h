...
#include <aims/signalfilter/filteringfunction_element.h>      // aims::NonLinFilterFunc
...
namespace aims {
  ...
  /// \param f       function to use (must derive from \c ElementFilteringFunction)
  ...
  inline VoxelType multichannelfiltervalues_nonlin(
    const ElementFilteringFunction<typename VoxelType::ChannelType> & f,
