...
#ifndef AIMS_SIGNALFILTER_FILTERINGFUNCTION_LINEAR_RGB_D_H
#define AIMS_SIGNALFILTER_FILTERINGFUNCTION_LINEAR_RGB_D_H

//--- aims -------------------------------------------------------------------
#include <aims/signalfilter/filteringfunction_linear_rgb.h>
#include <aims/signalfilter/filteringfunction_linear.h>      // aims::LinFilterFunc
