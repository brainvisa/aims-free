...
%End
  ...
  public:
      static rc_ptr_Volume_%Template1typecode% allocateResampledVolume(
        ...
        const soma::AffineTransformation3dBase & tr );
...
%End
      static vector_S32 getTransformedDims(
        const vector_S32 & dims, const soma::AffineTransformation3dBase & tr );
      static vector_FLOAT getTransformedVoxelSize(
        const vector_FLOAT & vs, const soma::AffineTransformation3dBase & tr );
};
