...
***********************************************************
PyAims tutorial : programming with AIMS in Python3 language
***********************************************************

This is the version of the tutorial for Python 3 (3.4 or higher). The Python2 version can be found :ref:`on this page <pyaims_tuto_py2>`
